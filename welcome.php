						...
						<div class="col-sm-6">
							 <div class="card">
						      <div class="card-body" style="width: 20rem;">
						        ...
						        <p class="card-text">Here you can create invoices and order new items.</p>
						        <a href="order/add.php" class="btn btn-primary">Order</a>
								<a href="order/manage.php" class="btn btn-primary">View</a>
						      </div>
						    </div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card-body" style="width: 20rem;">
						        ...
						        <p class="card-text">Here you can Add and Manage customers.</p>
						        <a href="customer/add.php" class="btn btn-primary mx-edit fa fa-add">Add </a>
						        <a href="customer/manage.php" class="btn btn-primary mx-edit fa fa-edit">Manage </a>
							</div>
							</div>
					...
					<div class="card">
						      <div class="card-body" style="width: 20rem;">
						        ...
						        <a href="add.php" class="btn btn-primary mx-edit fa fa-add">Add </a>
						        <a href="manage.php" class="btn btn-primary mx-edit fa fa-edit">Manage </a>
							</div>
							</div>
